...
- Time: 2026-08-22 16:24-18:24 +08:00
...
| --- | --- | --- |
| `pnpm ci:check` | exit 0 | lint 485 files, 0 errors and 506 historical warnings; typecheck 8/8 tasks; workspace 163/163; Config 34/34; Shared 69/69; Server 588 passed/10 skipped; Web 211/211; UI typecheck; build 5/5 packages and Web 14/14 static pages |
...
| --- | --- | --- | --- |
| Workspace invariants | 163 passed | n/a | n/a |
