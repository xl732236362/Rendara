...
- Time: 2026-08-22 16:24-17:12 +08:00
...
| --- | --- | --- |
| `pnpm ci:check` | exit 0 | lint 485 files, 0 errors and 506 historical warnings; typecheck 8/8 tasks; workspace 128/128; Config 34/34; Shared 69/69; Server 588 passed/10 skipped; Web 211/211; UI typecheck; build 5/5 packages and Web 14/14 static pages |
...
| --- | --- | --- | --- |
| Workspace invariants | 128 passed | n/a | n/a |
...
- Architecture TDD: the original gate first failed because `collectPhase6AArchitectureSources` was absent. First-review hardening added 13 bypass fixtures; that RED run passed 95 and failed 13. Second-review provenance, direct V2 request, SQL and unknown-GET fixtures produced a fresh RED of 109 passed and 14 failed. A final alias/owner/global-forwarding audit then produced 125 passed and 3 failed. After authoritative module/export resolution and fail-closed GET/V2 ownership checks, the final workspace run passed 128/128, including 39 Phase 6A checks and a full production-source scan.
...
The fail-closed GET inventory contains 29 registered production routes: the 16 collection routes above plus 13 explicitly justified singleton routes. Every hard-coded `app.get` path must be classified; an unknown GET fails even when its service or SQL method name is unfamiliar.
