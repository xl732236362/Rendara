...
- Time: 2026-08-22 16:24-17:29 +08:00
...
| --- | --- | --- |
| `pnpm ci:check` | exit 0 | lint 485 files, 0 errors and 506 historical warnings; typecheck 8/8 tasks; workspace 143/143; Config 34/34; Shared 69/69; Server 588 passed/10 skipped; Web 211/211; UI typecheck; build 5/5 packages and Web 14/14 static pages |
...
| --- | --- | --- | --- |
| Workspace invariants | 143 passed | n/a | n/a |
...
The fail-closed GET inventory contains 29 registered production routes: the 16 collection routes above plus 13 explicitly justified singleton routes. One shared discovery pass resolves literal/const `app.get` paths and `app.route` GET method/path objects for both the scanner and inventory audit. Unknown or dynamic GET paths fail even when their service or SQL method name is unfamiliar.
