...
- [x] **Step 4: Delegate the compatibility hook to the reducer**
...
- [x] **Step 4: Implement bounded terminal retention**
...
- [x] **Step 3: Compose controller in the canvas page**
...
- [x] **Step 2: Verify RED, then align production structure**
...
- [x] **Step 4: Update governance evidence**
